...
@WebServlet(name = "ProductsListController", value = "/personalArea/administration/products/productsList")
public final class ProductsListController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher(
                PageMapper.getURL("productsList")
        );
